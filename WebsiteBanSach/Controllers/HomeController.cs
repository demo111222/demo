        ...
        public ActionResult Login(User user)
        {
            ...
            { 
                ...
                if(usr!=null)
                {
                    ...
                    if (Session["UserGroup"].ToString() == "Admin" || Session["UserGroup"].ToString() == "Mod" || Session["UserGroup"].ToString()=="StandbyAccount")
                    {
                        return RedirectToAction("Index", "Admin/trang-chu");/* D:\DACS\WebsiteBanSach\WebsiteBanSach\Areas\Admin\Views\Home\Index.cshtml*/
                    }
                    else
                    {
